...
class GigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post gigs_url, params: { gig: { date: @gig.date, gig: @gig.gig, info: @gig.info, link: @gig.link, linkname: @gig.linkname } }
    end
  ...
  test "should update gig" do
    patch gig_url(@gig), params: { gig: { date: @gig.date, gig: @gig.gig, info: @gig.info, link: @gig.link, linkname: @gig.linkname } }
